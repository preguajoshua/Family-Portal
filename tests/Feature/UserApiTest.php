...
class UserApiTest extends TestCase
{
    ...
    public function a_new_user_and_associated_resources_are_created()
    {
        ...
        $response = $this->withToken($this->apiToken)->postJson('/api/v3/users', [
            'name' => 'John Doe',
    ...
    /** @test  */
    public function associated_user_resources_are_created_when_the_user_and_a_different_account_relationship_already_exist()
    {
        Http::fake([
            '*' => Http::response('As the user is already created, the Identity endpoint should not be hit.', 500),
        ]);
        ...
        $response = $this->withToken($this->apiToken)->postJson('/api/v3/users', [
            ...
            'agency_name' => 'A Different Agency',
            'application_id' => UserApiFixtures::APPLICATION_ID,
            'patient_id' => UserApiFixtures::PATIENT_ID,
            'patient_contact_id' => UserApiFixtures::PATIENT_CONTACT_ID,
        ]);
        ...
        $this->assertDatabaseCount('userapplications', 2);
        $this->assertDatabaseHas('patients', [
            'emr_patient_id' => UserApiFixtures::PATIENT_ID,
            'emr_patient_contact_id' => UserApiFixtures::PATIENT_CONTACT_ID,
        ]);
    ...
    public function a_patient_can_be_deleted()
    {
        ...
        $response = $this->withToken($this->apiToken)->deleteJson('/api/v3/users/patient-contact', [
            'patient_id' => UserApiFixtures::PATIENT_ID,
            'patient_contact_id' => UserApiFixtures::PATIENT_CONTACT_ID,
        ]);
    ...
    public function a_patient_can_be_moved_to_another_account()
    {
        ...
        $response = $this->withToken($this->apiToken)->patchJson('/api/v3/users/patient-contact', [
            'name' => 'Jane Doe',
    ...
    {
        $response = $this->postJson('/api/v3/users');
    ...
    public function user_resources_cannot_be_reached_with_an_invalid_api_token()
    {
        ...
        $response = $this->withToken($invalidApiToken)->postJson('/api/v3/users', [
            'name' => 'John Doe',
            'email' => 'john@example.com',
            'AgencyId' => UserApiFixtures::AGENCY_ID,
            'agency_name' => UserApiFixtures::AGENCY_NAME,
    ...
    public function ensure_the_request_is_validated_for_required_fields($requestField)
    {
        ...
        $response = $this->withToken($this->apiToken)->postJson('/api/v3/users', $requestAttributes);
    ...
    /** @test  */
    public function a_patient_can_not_be_moved_to_an_account_it_is_already_attached_to()
    {
        Http::fake([
            '*' => Http::response('As the user is already created, the Identity endpoint should not be hit.', 500),
        ]);
        ...
        Patient::factory()->create([
            'account_user_id' => AccountUser::where('user_id', $user->id)->where('account_id', $account->id)->first(),
            'emr_patient_id' => UserApiFixtures::PATIENT_ID,
            'emr_patient_contact_id' => UserApiFixtures::PATIENT_CONTACT_ID,
        ]);
